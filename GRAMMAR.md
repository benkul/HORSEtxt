...
the animal is showing would be annotating, and this one shows exactly as much.
...
### 14.1 The horse, drawn

Beside the trace stands the animal itself: a horse drawn in the page (SVG), reading the
same stream. It is not a mascot — it is state. Watch the horse and you are watching the
program.
